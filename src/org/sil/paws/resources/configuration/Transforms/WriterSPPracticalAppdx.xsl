...
<xsl:template match="/" mode="appdx">
    <appendix id="aAppdx">
        ...
        <p>
<xsl:text>Este apéndice presenta una explicación técnica lingüística de las consonantes y las vocales del </xsl:text>
<xsl:choose>
...
<xsl:text>.</xsl:text>
        ...
        <section1 id="sConsonants">
            ...
            <p>
<xsl:text>Las consonantes que se presentan en el </xsl:text>
<xsl:choose>
<xsl:when test="string-length(normalize-space(//language/langNames/langName[@lang='es'])) &gt; 0">
<xsl:value-of select="normalize-space(//language/langNames/langName[@lang='es'])" />
</xsl:when>
...
<xsl:text>.  También se presenta la identificación de estos sonidos en el alfabeto fonético, si hay diferencias, se presentan los símbolos de la ortografía práctica entre paréntesis.</xsl:text>
</p>
           <p>
<object type="tComment">Observe que el cuadro contiene muchos más símbolos del alfabeto fonético que los que su lengua tiene. Debe suprimir cualquiera de los símbolos y posiblemente también columnas o filas que no se usan en su lengua. Además, es necesario incorporear el símbolo de la ortografía práctica entre paréntesis después del símbolo fonético dondequiera que son diferentes. </object>
</p>
...
<xsl:text>lIPA</xsl:text>
        ...
        <section1 id="sVowels">
            ...
            <p>
<xsl:text>Las vocales que se presentan en el </xsl:text>
<xsl:choose>
<xsl:when test="string-length(normalize-space(//language/langNames/langName[@lang='es'])) &gt; 0">
<xsl:value-of select="normalize-space(//language/langNames/langName[@lang='es'])" />
</xsl:when>
...
<xsl:text>.  También se presenta la identificación de estos sonidos en el alfabeto fonético, con los símbolos de la ortografía práctica entre paréntesis, si hay diferencias.</xsl:text>
</p>
           <p>
<object type="tComment">Observe que el cuadro contiene muchos más símbolos del alfabeto fonético que los que su lengua tiene. Debe suprimir cualquiera de los símbolos y posiblemente también columnas o filas que no se usan en su lengua. Además, es necesario incorporear el símbolo de la ortografía práctica entre paréntesis después del símbolo fonético dondequiera que son diferentes. </object>
</p>
