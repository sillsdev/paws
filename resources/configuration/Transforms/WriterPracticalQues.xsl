...
<xsl:otherwise>who</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>what</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>why</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>where</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>how</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>how many or how much</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>which</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>whose</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>other interrogatives</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
