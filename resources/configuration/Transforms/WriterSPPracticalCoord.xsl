...
<xsl:otherwise>y luego</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>y/o</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>pero</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>otros (si hay)</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>o (cualquiera) - elemento inicial</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>o - elemento del medio</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>ni (ningunos) - elemento inicial</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:otherwise>ni - elemento del medio</xsl:otherwise>
</xsl:choose>
</gloss>
</td>
</xsl:for-each>
...
<xsl:value-of select="$sMasterLetterList" />
           ...
           <p>
<xsl:text> Algunos ejemplos de la coordinación a nivel de la oración que expresa una secuencia de eventos son:</xsl:text>
</p>
